...
class CommandClient extends detritus_utils_1.EventSpewer {
    ...
    setSubscriptions() {
        ...
        subscriptions.push(this.client.subscribe(constants_1.ClientEvents.MESSAGE_CREATE, this.handle.bind(this, constants_1.ClientEvents.MESSAGE_CREATE)));
        ...
        subscriptions.push(this.client.subscribe(constants_1.ClientEvents.MESSAGE_UPDATE, this.handle.bind(this, constants_1.ClientEvents.MESSAGE_UPDATE)));
    }
    /* Kill/Run */
    kill() {
        this.client.kill();
    ...
    async handle(name, event) {
        ...
        const context = new context_1.Context(message, typing || null, this);
        let attributes = null;
        try {
            if (!message.fromUser) {
