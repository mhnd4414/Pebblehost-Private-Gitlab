...
class GatewayDispatchHandler {
    ...
    [constants_1.GatewayDispatchEvents.GUILD_MEMBER_UPDATE](data) {
        ...
        let member;
        const userId = data['user']['id'];
        const isListening = this.client.hasEventListener(constants_1.ClientEvents.GUILD_MEMBER_UPDATE) || this.client.hasEventListener(constants_1.ClientEvents.USERS_UPDATE);
        if (this.client.members.has(guildId, userId)) {
            member = this.client.members.get(guildId, userId);
            if (isListening) {
    ...
    [constants_1.GatewayDispatchEvents.PRESENCE_UPDATE](data) {
        ...
        if (this.client.hasEventListener(constants_1.ClientEvents.PRESENCE_UPDATE) || this.client.hasEventListener(constants_1.ClientEvents.USERS_UPDATE)) {
